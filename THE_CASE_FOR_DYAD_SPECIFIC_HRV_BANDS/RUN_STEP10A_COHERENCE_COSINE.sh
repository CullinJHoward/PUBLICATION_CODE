...
#SBATCH --output=COH_COSINE_logs/COH_COSINE_%A_%a.out

#SBATCH --error=COH_COSINE_logs/COH_COSINE_%A_%a.err
...
Rscript TR_STEP10A_DYAD_LEVEL_COSINE_PATTERNS_COHERENCE_SLURM_FRIENDLY.R
