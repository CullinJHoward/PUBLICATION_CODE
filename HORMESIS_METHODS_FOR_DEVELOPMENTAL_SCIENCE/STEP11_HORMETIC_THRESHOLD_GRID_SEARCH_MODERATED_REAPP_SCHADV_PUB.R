...
out_file <- "C:\\Users\\cjh37695\\Dropbox\\HORMESIS_METHODS\\ANALYSIS\\STRUCTURAL\\MODERATED\\reapp_lineargrowth_schadv_pub_threshold_search.out"

# Output prefix for saved files.
out_prefix <- "REAP_SCHADVxPUB_THRESH"
...
outcome_direction <- "lower_is_worse"
...
print(alternative_thresholds, n = 36)
...
p_traj <- ggplot(
  ...
  labs(
    title = "Expected Growth Trajectories Across School Adverity and Pubertal Tempo",
    subtitle = paste0(
      "Reference is fixed at low School Adversity with moderators/covariates held at mean/zero. ",
